...
class UsersController extends Controller
{
    ...
    public function add()
    {
        ...
        return view("administrator.users.add",compact("user_groups","data_user", "company_id"));
    }
    ...
    public function save(Request $request)
    {
        ...
        $data = [
            ...
            'general_admin'     => $request->has('general_admin') ? 1 : 0,
    ...
    public function edit($id)
    {
        ...
        return view("administrator.users.edit", compact("user_groups", "edit", "company_id"));
    }
    ...
    public function update(Request $request)
    {
        ...
        $data = [
            ...
            'name'              => $request->name,
            'email'             => $request->email,
            'cashier'           => $request->has('cashier') ? $request->store_id : 0,
            'warehouse_pic'     => $request->has('warehouse_pic') == null ? 0 : $request->warehouse_id,
            'status'            => $request->has('status') ? 1 : 0,
        ];
