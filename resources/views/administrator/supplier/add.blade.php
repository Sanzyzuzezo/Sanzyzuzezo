    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form id="form_add" class="form d-flex flex-column flex-lg-row" action="{{ route('admin.supplier.save') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" name="name" class="form-control mb-2" placeholder="Name Supplier" value="" />
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" name="phone" class="form-control mb-2" placeholder="No Telephone / HP" value="" />
                                    <div class="text-muted fs-7"></div>
                                </div>
                                <div class="mb-10 fv-row">
                                    <label class="form-label">Contact Pic</label>
                                    <input type="text" name="contact_pic" class="form-control mb-2" placeholder="Contact Pic" value="" />
                                    <div class="text-muted fs-7"></div>
                                </div>
                                <div class="mb-10 fv-row">
                                    <label class="form-label">No Telephone / HP Pic</label>
                                    <input type="text" name="pic_phone" class="form-control mb-2" placeholder="No Telephone / HP Pic" value="" />
                                    <div class="text-muted fs-7"></div>
                                </div>
                                <div class="mb-10 fv-row">
