                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            ...
                            <div class="card-toolbar">
                                @if (isAllowed('supplier', 'add'))
                                    <a href="{{ route('admin.supplier.add') }}" class="btn btn-sm btn-light-primary">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="supplier_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-100px">Pic Phone</th>
...
@push('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var data_supplier = $('#supplier_table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
            ...
            $('#searchdatatable').keyup(function() {
                data_supplier.search($(this).val()).draw();
            })

            $('#filterstatus').change(function() {
                data_supplier.search($("#searchdatatable").val()).draw();
            })
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function() {
                                ...
                                data_supplier.ajax.reload(null, false);
                            }
                        });
            ...
            $(document).on('click', '.changeStatus', function(event) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "POST",
                            url: "{{ route('admin.supplier.changeStatus') }}",
                            data: ({
                                "_token": "{{ csrf_token() }}",
                                ix: ix,
                                status: changeto,
