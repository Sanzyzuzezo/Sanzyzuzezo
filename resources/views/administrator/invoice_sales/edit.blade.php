        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <form id="form" class="form d-flex flex-column flex-lg-row"
                    action="{{ route('admin.invoice_sales.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                                ...
                                <div class="card-body pt-0">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <input type="text" name="invoice_sales_number"
                                                    ...
                                                    value="{{ $data->invoice_sales_number }}" readonly />
                                            </div>
                                        </div>
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <a href="javascript:void(0)" class="btn btn-sm btn-primary data_disabled" title="Search"
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <select class="form-select" id="invoice_type" name="invoice_type" disabled>
                                                    <option value="">Please Select</option>
                                                    <option value="sales" {{ $data->sales_id !== 0 ? 'selected' : '' }}>
                                                        Sales</option>
                                                    <option value="delivery_note"
                                                        {{ $data->delivery_note_id !== 0 ? 'selected' : '' }}>Delivery Note
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="mb-10 fv-row {{ $data->sales_id === 0 ? 'd-none' : '' }}"
                                        id="fieldSales">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <input type="text" name="sales_number"
                                                    ...
                                                    value="{{ $data->sales_id !== 0 ? $data->sales_number : '' }}"
                                                    readonly />
                                                <input type="hidden" name="sales_id" id="sales_id"
                                                    class="form-control"
                                                    value="{{ $data->sales_id !== 0 ? $data->sales_id : '' }}" />
                                            </div>
                                            <div class="col-auto">
                                    ...
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="mb-10 fv-row {{ $data->delivery_note_id === 0 ? 'd-none' : '' }}"
                                        id="fieldDeliveryNote">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <input type="text" name="delivery_note_number"
                                                    ...
                                                    value="{{ $data->delivery_note_id !== 0 ? $data->delivery_note_number : '' }}"
                                                    readonly />
                                                <input type="hidden" name="delivery_note_id" id="delivery_note_id"
                                                    class="form-control"
                                                    value="{{ $data->delivery_note_id !== 0 ? $data->delivery_note_id : '' }}" />
                                            </div>
                                            <div class="col-auto">
                                                <a href="javascript:void(0)" class="btn btn-sm btn-primary data_disabled"
                                            ...
                                            <div class="col-md-12">
                                                <table class="table align-middle table-row-dashed fs-6 gy-5"
                                                    ...
                                                    <tbody class="fw-bold text-gray-600" id="bodyTableDataInvoiceSales">
                                                        ...
                                                        <tr id="row_detail_{{ $row->item_variant_id }}"
                                                            class="row_detail" childidx="{{ $key }}">
                                                            <td class="no-item">{{ $key + 1 }}</td>
                                                            <td class="img-item"><img width="50px"
                                                                    src="{{ img_src($row->data_file, 'product') }}"
                                                                    alt=""></td>
                                                            <td class="nama_item-item">{{ $row->nama_item }}</td>
                                                            <td class="nama_item_variant-item">
                                                                {{ $row->nama_item_variant }}</td>
                                                            <td class="price-item text-end">{{ $row->price }}</td>
                                                            <td class="fv-row">
                                                                <input type="hidden" name="detail[{{ $key }}][detail_id]"
                                                                    class="detail_id-item" value="{{ $row->id }}">
                                                                <input type="hidden" class="item_variant_id-item"
                                                                    name="detail[{{ $key }}][item_variant_id]"
                                                                    value="{{ $row->item_variant_id }}">
                                                                <input type="hidden" class="first_quantity-item"
                                                                    value="{{ $row->quantity_total - $sumqty[$row->item_variant_id] + $row->quantity }}">
                                                                <input type="text"
                                                                    class="form-control quantity-item text-end"
                                                                    value="{{ $row->quantity }}"
                                                                    name="detail[{{ $key }}][quantity]"
                                                                    autocomplete="off">
                                                                <span
                                                                    class="fv-plugins-message-container invalid-feedback message_quantity-item"></span>
                                                            </td>
                                                            <td class="fv-row">
                                                                <input type="text"
                                                                    name="detail[{{ $key }}][total]"
                                                                    class="form-control bg-secondary total-item text-end"
                                                                    value="Rp {{ number_format($row->total_payment, 0, ',', '.') }}"
                                                                    readonly>
                                                            </td>
                                                            <td>
                                                                <a href="javascript:void(0)"
                                                                    class="btn btn-sm btn-icon btn-light btn-active-light-primary {{$data_detail->count() === 1 ? 'data_disabled' : ''}} triggerDeleteDetail"
                                                                    data-id="{{ $row->item_variant_id }}"
                                                                    data-invoice_sales-id="{{ $row->id }}"
                                                    ...
                                                    <tfoot>
                                                        <tr
                                                            ...
                                                            <td class="text-end">
                                                                <div id="total_payment_amount">Rp
                                                                    {{ number_format($data->total_payment_amount, 0, ',', '.') }}
                                                                </div><input type="hidden" name="total_payment_amount"
                                                                    value="{{ $data->total_payment_amount }}"
            ...
            function resetData() {
                ...
                $(".row_detail").each(function() {
                    ...
                    $('.triggerDeleteDetail').on('click', function(e) {
                        let id = $(this).data('id');
                        let invoice_sales_id = $(this).data('invoice_sales-id');
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                if (invoice_sales_id != '') {
                                    $.ajax({
                                        type: "DELETE",
                                        url: "{{ route('admin.invoice_sales.deleteDetail') }}",
                                        data: ({
                                            "_token": "{{ csrf_token() }}",
                                            "_method": 'DELETE',
                                            id: invoice_sales_id,
                                        ...
                                        success: function(resp) {
                                            if (resp.success) {
                                                ...
                                                $.ajax({
                                                    type: "POST",
                                                    url: "{{ route('admin.invoice_sales.updateTotalPaymentAmount') }}",
                                                    data: ({
                                                        "_token": "{{ csrf_token() }}",
                                                        "_method": 'PUT',
                                                        id: invoice_sales_id,
                                                        total_payment_amount: parseRupiah(
                                                            $(
                                        ...
                                        .append(`
                                                <tr id="row_detail_${item_variant_id}" class="row_detail" childidx="0">
                                                    ...
                                                    <td class="fv-row">
                                                        ...
                                                        <span class="fv-plugins-message-container invalid-feedback message_quantity-item"></span>
                                                    </td>
                                                    <td class="fv-row">
                                                    ...
                                                    <td>
                                                        <a href="javascript:void(0)" class="btn btn-sm btn-icon btn-light btn-active-light-primary triggerDeleteDetail" data-id="${item_variant_id}" data-invoice_sales-id="" data-bs-toggle="tooltip" data-bs-placement="top">
