    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <!--begin::Form-->
                <form id="form" class="form d-flex flex-column flex-lg-row" action="{{ route('admin.sales.save') }}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <input type="text" name="sales_number" placeholder="Nomor Pembelian"
                                                    id="sales_number" class="form-control bg-secondary" readonly />
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <input type="text" name="courier_title"
                                                    ...
                                                    placeholder="Courier Name" value="" readonly />
                                                ...
                                                <table class="table align-middle table-row-dashed fs-6 gy-5"
                                                    ...
                                                    <tbody class="fw-bold text-gray-600" id="bodyTableDataSales">
                                                        {{-- <tr id="row_detail_" class="row_detail">
                                                            ...
                                                            <td>Rp 20.000</td>
                                                            <td>
                                                                <input type="hidden" name="detail[0][item_variant_id]"
                                                                    value="">
                                                    ...
                                                    <tfoot>
                                                        <tr
                                                            ...
                                                            <td class="text-end">
                                                                <div id="total_sales_amount">Rp 0</div><input
                                                                    type="hidden" name="total_sales_amount"
...
@push('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(i) {
                            ...
                            var stock = data[i].stock !== null ? data[i].stock : 0;
                            ...
                            if ($('#row_detail_' + id).length == 0) {
                                ...
                                $('#bodyTableDataSales').append(`
                                    <tr id="row_detail_${id}" class="row_detail" childidx="0">
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" class="btn btn-sm btn-icon btn-light btn-active-light-primary triggerDeleteDetail" data-id="${id}" data-bs-toggle="tooltip" data-bs-placement="top">
                                                <span class="svg-icon svg-icon-2">
                                ...
                                $.ajax({
                                    ...
                                    async: false,
                                    success: function(data) {
                                        $('#row_detail_' + id).find('.unit-item').empty()
                                        $('#row_detail_' + id).find('.unit-item').append(
                                            "<option value=''>Please Select</option>");
            ...
            $.ajax({
                url: "{{ route('admin.sales.generateSalesNumber') }}",
                type: "get",
                cache: false,
                async: false,
                success: function(data) {
                    $('#sales_number').val(data)
                }
            });
