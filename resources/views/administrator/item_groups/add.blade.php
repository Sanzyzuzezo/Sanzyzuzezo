    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <form class="form d-flex flex-column flex-lg-row" id="form" method="post" enctype="multipart/form-data" action="{{ route('admin.item_groups.insert') }}">
                    {{ csrf_field() }}
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <div class="fv-row">
                                    ...
                                    <input type="text" name="code" class="form-control mb-2" placeholder="Code" value=""/>
                                </div>
                            </div>
                            <div class="card-body pt-0">
                                <div class="fv-row">
