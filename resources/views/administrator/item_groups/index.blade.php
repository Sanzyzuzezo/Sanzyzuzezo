            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-dark">Item Groups</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card card-flush">
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            ...
                            <div class="card-toolbar">
                                @if (isAllowed("item_groups", "add"))
                                <a href="{{ route('admin.item_groups.add') }}" class="btn btn-sm btn-light-primary">
                    ...
                    <div class="card-body pt-0">
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="item-groups-table">
                            <thead>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            var data_item_groups = $('#item-groups-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "item_groups-data",
                    dataType: "JSON",
                    type: "GET",
                    data:function(d){
                        d.status = getStatus();
            ...
            $('#searchdatatable').keyup(function() {
                data_item_groups.search($(this).val()).draw();
            })

            $('#filterstatus').change(function() {
                data_item_groups.search($("#searchdatatable").val()).draw();
            })
            ...
            $(document).on('click', '.delete', function(event) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "POST",
                            url: "{{ route('admin.item_groups.delete') }}",
                            data: ({
                                "_token": "{{ csrf_token() }}",
                                "_method": 'DELETE',
                                ix: ix,
                            ...
                            success: function(resp){
                                ...
                                data_item_groups.ajax.reload(null, false);
                            },
                            error: function (resp) {
