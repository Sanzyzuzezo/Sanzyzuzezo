            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Rekap Absensi Per Tahun</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            <div class="w-100 mw-150px">
                                @php
                                    ...
                                    $lastYear = \Carbon\Carbon::now()->subYear(1)->year;
                                    $twoYearsAgo = \Carbon\Carbon::now()->subYear(2)->year;
                                @endphp
                                <select class="form-select btn-sm form-select-solid" data-control="select2" data-hide-search="true" id="filter_tahun">
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route("admin.human_resource_tahun.exportExcel") }}" class="btn btn-sm btn-light-success" id="exportIndexExcelTahun">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var data_store = $('#store_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('admin.human_resource.rekap_absensi_per_tahun.get_data') }}',
                    dataType: "JSON",
                    type: "GET",
                    data: function(d) {
            ...
            $(document).ready(function() {
                setParams($('#searchdatatable').val(),$('#filter_tahun').val());
            })
            ...
            function setParams(search,tahun){
            linkExcel = '{{ route('admin.human_resource_tahun.exportExcel')}}' + '?search=filterTahun:'+tahun+'|filterSearch:'+search;
            $("#exportIndexExcelTahun").attr('href',linkExcel);
        } 
