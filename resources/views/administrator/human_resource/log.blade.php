            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Human Resource</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            <div class="w-100 mw-150px">
                                <div class="mb-0">
                                    <input class="form-control form-control-solid" placeholder="Pick date rage" id="filter_date"/>
                                </div>
                            </div>
                            <div class="w-100 mw-150px">
                            ...
                            <div class="card-toolbar">
                                @if (isAllowed('categories', 'add'))
                                    <a href="{{ route('admin.human_resource') }}" class="btn btn-sm btn-light-primary">
                            ...
                            <div class="card-toolbar">
                                <a href="{{ route("admin.human_resource.exportExcel") }}" class="btn btn-sm btn-light-success" id="exportIndexExcel">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="store_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-100px">Jam Keluar</th>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            setParams($('#filter_status').val(), $('#searchdatatable').val(), $('#filter_date').val(), $('#filter_karyawan').val());
        })
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var data_store = $('#store_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('admin.human_resource.getLog') }}',
                    dataType: "JSON",
                    type: "GET",
                    data: function(d) {
                        d.status = getStatus();
                        d.karyawan = $('#filter_karyawan').val();
                        d.status_kehadiran = $('#filter_status').val();
                        d.tanggal = $('#filter_date').val();
                    }
                },
                columns: [{
            ...
            $('#searchdatatable').keyup(function() {
                ...
                setParams($('#filter_status').val(), $(this).val(), $('#filter_date').val(), $('#filter_karyawan').val());
            })
            ...
            $('#filter_karyawan').change(function() {
                data_store.search($('#searchdatatable').val()).draw();
                setParams($('#filter_status').val(), $('#searchdatatable').val(), $('#filter_date').val(), $(this).val());
            })

            $('#filter_status').change(function() {
                data_store.search($('#searchdatatable').val()).draw();
                setParams($(this).val(), $('#searchdatatable').val(), $('#filter_date').val(), $('#filter_karyawan').val());
            })

            $('#filter_date').change(function() {
                data_store.search($('#searchdatatable').val()).draw();
                setParams($('#filter_status').val(), $('#searchdatatable').val(), $(this).val(), $('#filter_karyawan').val());
            })
        ...
        function setParams(status, search, date, karyawan){
            linkExcel = '{{ route('admin.human_resource.exportExcel')}}' + '?search=filterStatus:'+status+'|filterSearch:'+search+'|filterDate:'+date+'|filterKaryawan:'+karyawan;
