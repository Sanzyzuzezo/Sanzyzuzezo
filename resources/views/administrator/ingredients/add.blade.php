                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-dark">
                            {{ $ingredient ? 'Duplicate ' . $ingredient['information'] : 'Add' }}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form id="form" class="form d-flex flex-column flex-lg-row"
                    action="{{ route('admin.ingredients.save') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="card-body pt-0">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <input type="text" name="item_name" class="form-control" id="item_name"
                                                ...
                                                value="{{ $ingredient ? $ingredient->item_name : '' }}" readonly />
                                            <input type="hidden" name="item_id" id="item_id" class="form-control"
                                                value="{{ $ingredient ? $ingredient->item_id : '' }}" />
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <input type="text" name="item_variant_name" class="form-control"
                                                ...
                                                value="{{ $ingredient ? $ingredient->item_variant_name : '' }}" readonly />
                                            <input type="hidden" name="item_variant_id" id="item_variant_id"
                                                class="form-control"
                                                value="{{ $ingredient ? $ingredient->item_variant_id : '' }}" />
                                            <div class="invalid-variant" id="check_data_variant"></div>
                                        </div>
                                        <div class="col-auto">
                                            <a href="#"
                                                class="btn btn-sm btn-primary {{ $ingredient ? '' : 'data_disabled' }}"
                                                id="triggerItemVariant" data-bs-toggle="modal">
                                                <span class="svg-icon svg-icon-2 m-0">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        viewBox="0 0 24 24" fill="none">
                                                        <path
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <a href="#"
                                            class="btn btn-sm btn-primary {{ $ingredient ? '' : 'data_disabled' }}"
                                            id="triggerItemForIngredient" data-bs-toggle="modal">
                                        ...
                                        <div class="col-md-12">
                                            <table class="table align-middle table-row-dashed fs-6 gy-5"
                                                ...
                                                <tbody class="fw-bold text-gray-600" id="get-item-data">
                                                    @if (!empty($ingredient_detail))
                                                        @foreach ($ingredient_detail as $key => $data)
                                                            <tr id="ing{{ $data['item_variant_id'] }}"
                                                                ...
                                                                <td>
                                                                    <input type="text"
                                                                        class="form-control format-number withseparator text-end variant-price mb-2"
                                                                        autocomplete="off"
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0)"
                                                                        class="btn btn-sm btn-icon btn-light btn-active-light-primary delete"
                                                                        data-id="{{ $data['id'] }}"
                                                                        data-ing="{{ $data['item_variant_id'] }}"
                                                                        id="delete{{ $data['id'] }}"
...
@push('scripts')
    ...
    <script type="text/javascript">
                    ...
                    'information': {
                        validators: {
                            ...
                            remote: {
                                ...
                                method: 'POST',
                                url: '{{ route('admin.ingredients.isExistInformation') }}',
                                data: function() {
                                    return {
                                        _token: '{{ csrf_token() }}',
        ...
        function resetData() {
            ...
            var no = $('#ingredients_table').find('tr').length;
            if (no == 0) {
                no = '';
            }
                            ...
                            success: function(data) {
                                if ($('#ing' + id).length == 0) {
                                    $('#get-item-data').append('<tr id="ing' + id +
                                        ...
                                        .id +
                                        '"></td><td><input type="text" class="form-control format-number withseparator text-end variant-price mb-2" autocomplete="off" name="ingredients[' +
                                        number +
