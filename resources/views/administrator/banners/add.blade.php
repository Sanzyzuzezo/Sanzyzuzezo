    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <form class="form d-flex flex-column flex-lg-row" id="form" method="post" enctype="multipart/form-data" action="{{ route('admin.banners.insert') }}">
                    {{ csrf_field() }}
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <div class="fv-row">
                                    ...
                                    <input type="text" name="url" class="form-control mb-2" placeholder="Banner URL" value=""/>
                                </div>
                            </div>

                            <div class="card-body pt-0" id="button_url">
                                <div class="fv-row">
                                    <label class="form-label">Posisi Banner</label>
                                    <select name="posisi_banner" class="form-select" data-control="select2">
                                        <option value="atas">Slider Utama (Atas)</option>
...
@push('scripts')
    ...
    <script src="{{ asset_administrator('assets/js/custom/apps/ecommerce/catalog/banners.js') }}"></script>
