    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <form class="form d-flex flex-column flex-lg-row" id="form" method="post" enctype="multipart/form-data" action="{{ route('admin.banners.update', $banners->id) }}">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    {{-- <div>
                                        <input class="form-check-input" type="hidden" name="same_as_default"
                                            value="0" id="sameasdefault"/>
                            ...
                            <div class="card-body pt-0">
                                <div class="fv-row">
                                    ...
                                    {{-- <input type="date" name="date" class="form-control mb-2" value="{{ $banners->date    }}"/> --}}
                                    <input type="text" name="date" placeholder="Date" class="form-control kt_datepicker_1" value="{{ date('d-m-Y', strtotime($banners->date)) }}"/>
                                </div>
                            </div>
                            ...
                            <div class="card-body pt-0">
                                <div class="fv-row">
                                    ...
                                    <input type="text" name="url" class="form-control mb-2" placeholder="URL" value="{{ $banners->button_url }}"/>
                                </div>
                            </div>
                            ...
                            <div class="card-body pt-0">
                                <div class="fv-row">
                                    ...
                                    <select name="posisi_banner" class="form-select" data-control="select2">
                                        <option value="atas" {{ "atas" == $banners->posisi_banner ? 'selected' : '' }}>Slider Utama (Atas)</option>
                                        <option value="kanan" {{ "kanan" == $banners->posisi_banner ? 'selected' : '' }}> Kanan </option>
                                        <option value="bawah" {{ "bawah" == $banners->posisi_banner ? 'selected' : '' }}> Bawah </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="card-body pt-0">
                                    ...
                                    <div class="notice d-flex bg-light-dark rounded border-dark border border-dashed min-w-lg-600px flex-shrink-0 p-6">
                                        ...
                                        <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                            <div class="mb-3 mb-md-0 fw-bold">
                                                ...
                                                <div class="fs-6 text-gray-700 pe-7 py-1">
                                ...
                                @if($banners->image != null)
                                    <div class="row col-md-6 py-2">
                                        <img class='col-12' src="{{asset_administrator("assets/media/banners/$banners->image")}}" />
                                    </div>
                                @endif
                            </div>
                            <div class="card-body pt-0">
                                <div class="fv-row">
                                    ...
                                    <div class="form-check form-switch form-check-custom form-check-solid">
                                        <input class="form-check-input" type="checkbox" value="1" id="status" name="status" @if($banners->status == 1) checked="checked" @endif />
