            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Editor-->
                                    <div class="description min-h-200px mb-2" name="description" disabled>
                                        {!! $detail->description !!}
                                    </div>
                                    <!--end::Editor-->
                                    <!--begin::Description-->
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="mb-10 fv-row">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <select name="variants[{{ $index }}][unit]" class="form-select variant-unit" disabled>
                                                        ...
                                                        <div class="mb-10 row">
                                                            <div class="col-lg-4">
                                                                <div class="form-check form-check-custom form-check-solid mb-2">
                                                                    <input class="form-check-input variant-sale" type="checkbox" name="variants[{{ $index }}][sale]" id="variants[{{ $index }}][sale]" value="1" {{ $variant->sale == 1 ? 'checked' : '' }} disabled/>
                                                                    <label class="form-check-label" for="variants[{{ $index }}][sale]">Sale?</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <div class="form-check form-check-custom form-check-solid mb-2">
                                                                    <input class="form-check-input variant-bought" type="checkbox" name="variants[{{ $index }}][bought]" id="variants[{{ $index }}][bought]" value="1" {{ $variant->bought == 1 ? 'checked' : '' }} disabled/>
                                                                    <label class="form-check-label" for="variants[{{ $index }}][bought]">Bought?</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <div class="form-check form-check-custom form-check-solid mb-2">
                                                                    <input class="form-check-input variant-ingredient" type="checkbox" name="variants[{{ $index }}][ingredient]" id="variants[{{ $index }}][ingredient]" value="1" {{ $variant->ingredient == 1 ? 'checked' : '' }} disabled/>
                                                        ...
                                                        <div class="mb-10 row">
                                                            <div class="col-lg-4">
                                                                <div class="form-check form-check-custom form-check-solid mb-2">
                                                                    <input class="form-check-input variant-show_online_shop" type="checkbox" name="variants[{{ $index }}][show_online_shop]" id="variants[{{ $index }}][show_online_shop]" value="1" {{ $variant->show_online_shop == 1 ? 'checked' : '' }} disabled/>
                                                                    <label class="form-check-label" for="variants[{{ $index }}][show_online_shop]">Show In Online Shop Module?</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <div class="form-check form-check-custom form-check-solid mb-2">
                                                                    <input class="form-check-input variant-show_pos" type="checkbox" name="variants[{{ $index }}][show_pos]" id="variants[{{ $index }}][show_pos]" value="1" {{ $variant->show_pos == 1 ? 'checked' : '' }} disabled/>
                                                                    <label class="form-check-label" for="variants[{{ $index }}][show_pos]">Show In POS Module?</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <div class="form-check form-check-custom form-check-solid mb-2">
                                                                    <input class="form-check-input variant-production" type="checkbox" name="variants[{{ $index }}][production]" id="variants[{{ $index }}][production]" value="1" {{ $variant->production == 1 ? 'checked' : '' }} disabled/>
                                                                ...
                                                                <div class="fv-row">
                                                                    ...
                                                                    <div class="input-group mb-5">
                                                                        <input type="text"
                                                                            ...
                                                                            placeholder="Weight"
                                                                            value="{{ number_format($variant->weight, 2, '.', ',') }}" disabled/>
                                                                    ...
                                                                    <div class="col-md-12 col-sm-12">
                                                                        <div class="input-group mb-5">
                                                                            <input type="text"
                                                                                ...
                                                                                placeholder="Length"
                                                                                value="{{ !empty($dimension) && array_key_exists('length',$dimension) ? ($dimension['length'] != '' ? number_format($dimension['length'], 2, '.', ',') : '') : '' }}" disabled/>
                                                                            <span class="input-group-text"
                                                                    ...
                                                                    <div class="col-md-12 col-sm-12">
                                                                        <div class="input-group mb-5">
                                                                            <input type="text"
                                                                                ...
                                                                                placeholder="Width"
                                                                                value="{{ !empty($dimension) && array_key_exists('width',$dimension) ? ($dimension['width'] != '' ? number_format($dimension['width'], 2, '.', ',') : '') : '' }}" disabled/>
                                                                            <span class="input-group-text"
                                                                                id="basic-addon2">cm</span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12 col-sm-12">
                                                                        <div class="input-group mb-5">
                                                                            <input type="text"
                                                                                ...
                                                                                placeholder="Height"
                                                                                value="{{ !empty($dimension) && array_key_exists('height',$dimension) ? ($dimension['height'] != '' ? number_format($dimension['height'], 2, '.', ',') : '') : '' }}" disabled/>
                                                                            <span class="input-group-text"
                                                                                id="basic-addon2">cm</span>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-6 mb-5 fv-row">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        placeholder="Price"
                                                                        value="{{ number_format($variant->price, 2, '.', ',') }}" disabled/>
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                    <div class="text-muted fs-7"></div>
                                                                    <!--end::Description-->
                                                            ...
                                                            <div class="col-6 mb-5 fv-row">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        class="form-control withseparator format-number text-end variant-price mb-2"
                                                                        placeholder="Price"
                                                                        value="{{ number_format($variant->discount_price, 2, '.', ',') }}" disabled/>
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                    <div class="text-muted fs-7"></div>
                                                                    <!--end::Description-->
                                                            ...
                                                            <div class="col-6 mb-5 fv-row">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        value="{{ number_format($variant->minimal_stock, 2, '.', ',') }}" disabled/>
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                    <div class="text-muted fs-7"></div>
                                                                    <!--end::Description-->
                    ...
                    <div class="d-flex justify-content-end">
                        <!--begin::Button-->
                        <a href="{{ route('admin.items') }}" id="kt_ecommerce_add_item_cancel"
