        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <form id="form_add" class="form d-flex flex-column flex-lg-row"
                    action="{{ route('admin.items.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PUT') }}
                                                                        ...
                                                                        <div class="col-md-12 col-sm-12">
                                                                            <div class="input-group mb-5">
                                                                                <input type="text"
                                                                                    ...
                                                                                    placeholder="Length"
                                                                                    value="{{ !empty($dimension) && array_key_exists('length',$dimension) ? ($dimension['length'] != '' ? number_format($dimension['length'], 2, '.', ',') : '') : '' }}" />
                                                                                <span class="input-group-text"
                                                                        ...
                                                                        <div class="col-md-12 col-sm-12">
                                                                            <div class="input-group mb-5">
                                                                                <input type="text"
                                                                                    ...
                                                                                    placeholder="Width"
                                                                                    value="{{ !empty($dimension) && array_key_exists('width',$dimension) ? ($dimension['width'] != '' ? number_format($dimension['width'], 2, '.', ',') : '') : '' }}" />
                                                                                <span class="input-group-text"
                                                                                    id="basic-addon2">cm</span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12 col-sm-12">
                                                                            <div class="input-group mb-5">
                                                                                <input type="text"
                                                                                    ...
                                                                                    placeholder="Height"
                                                                                    value="{{ !empty($dimension) && array_key_exists('height',$dimension) ? ($dimension['height'] != '' ? number_format($dimension['height'], 2, '.', ',') : '') : '' }}" />
                                                                                <span class="input-group-text"
                                                                                    id="basic-addon2">cm</span>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="col-6 mb-5 fv-row">
                                                                    ...
                                                                    <div class="mb-10 fv-row">
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            class="form-control withseparator format-number text-end variant-price mb-2"
                                                                            placeholder="Price"
                                                                            value="{{ number_format($variant->discount_price, 2, '.', ',') }}" />
                                                                        <!--end::Input-->
                                                                        <!--begin::Description-->
                                                                        <div class="text-muted fs-7"></div>
                                                                        <!--end::Description-->
        ...
        function resetData() {
            ...
            $(".variant-list").each(function() {
                ...
                $(this).find('.form-check-label').each(function() {
                    $(this).attr("for", this.getAttribute("for").replace('[' + search_index + ']', '[' + index + ']'));
                });
