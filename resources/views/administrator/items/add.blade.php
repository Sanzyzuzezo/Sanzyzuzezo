        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <form id="form_add" class="form d-flex flex-column flex-lg-row"
                    action="{{ route('admin.items.save') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Main column-->
                                                            ...
                                                            <div class="col-6 mb-5 fv-row">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <input type="text" name="variants[0][discount_price]"
                                                                        class="form-control withseparator format-number text-end variant-discount-price mb-2"
                                                                        placeholder="Price" value="" />
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                    <div class="text-muted fs-7"></div>
    ...
    <script type="text/javascript">
        ...
        function resetData() {
            ...
            $(".variant-list").each(function() {
                ...
                validator.addField("variants[" + index + "][unit]", {
                    validators: {
                        notEmpty: {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            clonning.find(".variant-price").val($(another).find(".variant-price")
                                .val());
                            clonning.find(".variant-discount-price").val($(another).find(".variant-discount-price")
                                .val());
