                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" name="code" class="form-control mb-2" placeholder="Store Code" value="" />
                                    <div class="text-muted fs-7"></div>
                                </div>
                                <div class="mb-10 fv-row">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="hidden" class="warehouse-data" name="warehouse_data">
                                </div>
                            </div>
                        </div>
                        <div class="d-flex justify-content-end">
                            ...
                            <table class="table align-middle table-row-dashed datatable fs-6 gy-5" id="warehouse_data_table">
                                ...
                                <tbody class="fw-bold text-gray-400">
                                    @foreach ($warehouse as $row)
                                        <tr>
                                            <td>
                                                <input class="form-check-input item_warehouse" id="ing-{{ $row->id }}" type="checkbox" value="{{ $row->id }}" />
                                            </td>
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        $('#searchWarehouseTable').keyup(function () {
            $('#warehouse_data_table').DataTable().search($(this).val()).draw();
        });
        ...
        $('#warehouse_data_table').DataTable({
            ...
            $('#selectData-warehouse').off().on('click', function (e) {
                ...
                $('#warehouse_data_table').find('input[type="checkbox"]:checked').each(function (i) {
                    ...
                    if ($('#' + id).length == 0) {
                        // If not selected, append to the table
                        $.ajax({
                            url: "item-data",
                            data: { 'id': id },
                            type: "get",
                        ...
                        Swal.fire('Opps!', 'Warehouse is already selected !', 'warning');
                    }
                });
