                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" value="{{ $store->code }}" name="code" class="form-control mb-2" placeholder="Store Code" value="" />
                                    <div class="text-muted fs-7"></div>
                                </div>
                                <div class="mb-10 fv-row">
            ...
            $('#selectData-warehouse').off().on('click', function (e) {
                ...
                $('#warehouse_data_table').find('input[type="checkbox"]:checked').each(function(i){
                    ...
                    $('#delete'+id).off().on('click', function (e) {
                        ...
                        Swal.fire('Oops!', 'Warehouse is already selected !', 'warning');
                    }
                });
