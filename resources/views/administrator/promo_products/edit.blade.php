    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <form id="form" class="form d-flex flex-column flex-lg-row" action="{{ route('admin.promo_products.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PUT') }}
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" name="title" placeholder="Title" class="form-control" value="{{ $edit->title }}"/>
                                    <div class="text-muted fs-7">
                                    </div>
                                </div>
                                <div class="mb-10 fv-row">
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <input type="datetime-local" name="start_at" class="form-control" value="{{ $edit->start_at }}"/>
                                            <div class="text-muted fs-7">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="mb-10 fv-row">
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <input type="datetime-local" name="start_date" class="form-control" value="{{ $edit->start_date }}"/>
                                            <div class="text-muted fs-7">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label required">End Date</label>
                                            <input type="datetime-local" name="end_date" class="form-control" value="{{ $edit->end_date }}"/>
                                            <div class="text-muted fs-7">
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <td class="fv-row">
                                                                <div class="col-auto">
                                                                    <div class="form-check form-switch form-check-custom form-check-solid mb-1">
                                                                        <input class="form-check-input discount_type_product" type="checkbox" value="1" id="product[0][discount_type_product]" name="product[0][discount_type_product]" {{ $row->discount_type == 1 ? 'checked' : '' }}/>
                                                                    ...
                                                                    <input type="text" class="form-control form-white text-end discount_value_product format-number withseparator" name="product[0][discount_value_product]" data-max="{{ $row->price }}" value="{{ number_format($row->discount_value) }}" required>
                                                                </div>
                                                            </td>
                                                            <td class="px-0 after_discount_price text-end">{{ $row->after_discount_price }}</td>
                                                            {{-- <td class="px-0 stock text-end">{{ $row->stock }}</td> --}}
                                                            <td class="fv-row">
                                                                <input type="hidden" class="id" name="product[0][id]" value="{{ $row->id }}">
                                                                ...
                                                                {{-- <input type="text" class="form-control form-white text-end withseparator format-number promotion_stock" name="product[0][promotion_stock]" data-max="" value="{{ $row->promotion_stock }}" required> --}}
                                                            </td>
                                                            <td>
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <textarea name="note" class="form-control">{{ $edit->note }}</textarea>
                                </div>
                            </div>
                            <!--end::Card header-->
                        </div>
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{ route('admin.promo_products') }}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Cancel</a>
                            <!--end::Button-->
                            <!--begin::Button-->
    ...
    <table class="template-data" style="display: none;">
        <tr class="template-product-list" childidx="0" style="position: relative;">
            ...
            <td class="fv-row">
                ...
                {{-- <input type="text" class="form-control form-white text-end format-number withseparator promotion_stock" name="product[0][promotion_stock]" data-max="" required> --}}
            </td>
            <td>
                <a href="#" class="btn btn-sm btn-icon btn-light btn-active-light-primary removeData">
                    <span class="svg-icon svg-icon-2">
    ...
    <script type="text/javascript">
        ...
        function resetData() {
            ...
            $(".product-list").each(function () {
                ...
                //     if($(another).find(".discount_type_product").is(':checked')){
