...
@section('content')
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::productItem-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('admin.promo_products') }}" class="text-muted text-hover-primary">Promo Products</a>
                        </li>
                        <!--begin::productItem-->
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-300 w-5px h-2px"></span>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <select class="form-select" name="promo_type" disabled>
                                        <option value="">Please Select</option>
                                        <option value="flash_sale" {{ $edit->type == 'flash_sale' ? 'selected' : '' }}>Flash Sale</option>
                                        <option value="reguler" {{ $edit->type == 'reguler' ? 'selected' : '' }}>Reguler</option>
                                    </select>
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" name="title" placeholder="Title" class="form-control" value="{{ $edit->title }}" disabled/>
                                    <div class="text-muted fs-7">
                                    </div>
                                </div>
                                <div class="mb-10 fv-row">
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <input type="datetime-local" name="start_at" class="form-control" value="{{ $edit->start_at }}" disabled />
                                            <div class="text-muted fs-7">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="mb-10 fv-row">
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <input type="datetime-local" name="start_date" class="form-control" value="{{ $edit->start_date }}" disabled/>
                                            <div class="text-muted fs-7">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label required">End Date</label>
                                            <input type="datetime-local" name="end_date" class="form-control" value="{{ $edit->end_date }}" disabled/>
                                            <div class="text-muted fs-7">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-auto">
                                            <div class="form-check form-switch form-check-custom form-check-solid">
                                                <input class="form-check-input discount_type" type="checkbox"
                                                    value="1" id="discount_type" name="discount_type" checked disabled/>
                                                <label class="form-check-label fw-bold text-gray-400 ms-3 discount_label"
                                                    for="discount_type">Percentage (%)</label>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <input type="text" name="discount_value" min="1" max="100"
                                                class="form-control discount_value" value="" disabled />
                                        </div>
                                    </div>
                                    <div class="text-muted fs-7">
                                    </div>
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="listDataProduct">
                                                <!--begin::Table head-->
                                                <thead>
                                                    <!--begin::Table row-->
                                                ...
                                                <tbody class="fw-bold text-gray-600" id="get-product-data">
                                                    @foreach ($promotion_products as $row)
                                                        <tr class="product-list" childidx="0" style="position: relative;">
                                                            <td class="px-0 product_name">{{ $row->product_name }}</td>
                                                            <td class="px-0 sku">{{ $row->sku }}</td>
                                                            <td class="px-0 variant_name">{{ $row->variant_name }}</td>
                                                            <td class="px-0 price text-end">{{ $row->price }}</td>
                                                            <td>
                                                                <div class="col-auto">
                                                                    <div class="form-check form-switch form-check-custom form-check-solid mb-1">
                                                                        <input class="form-check-input discount_type_product" type="checkbox" value="1" id="product[0][discount_type_product]" name="product[0][discount_type_product]" {{ $row->discount_type == 1 ? 'checked' : '' }} disabled/>
                                                                        <label class="form-check-label fw-bold text-gray-400 ms-3 discount_label_product" for="product[0][discount_type_product]">{{ $row->discount_type == 1 ? 'Percentage (%)' : 'Amount' }}</label>
                                                                    </div>
                                                                    <input type="text" class="form-control form-white text-end discount_value_product" name="product[0][discount_value_product]" data-max="{{ $row->price }}" value="{{ $row->discount_value }}" disabled>
                                                                </div>
                                                            </td>
                                                            <td class="px-0 after_discount_price text-end">{{ $row->after_discount_price }}</td>
                                                            {{-- <td class="px-0 stock text-end">{{ $row->stock }}</td> --}}
                                                            <td>
                                                                <input type="hidden" class="product_id" name="product[0][product_id]" value="{{ $row->product_id }}">
                                                                <input type="hidden" class="variant_id" name="product[0][variant_id]" value="{{ $row->variant_id }}">
                                                                <input type="hidden" class="after_discount_price_value" name="product[0][after_discount_price]" value="{{ $row->after_discount_price }}">
                                                                {{-- <input type="text" class="form-control form-white text-end withseparator format-number promotion_stock" name="product[0][promotion_stock]" data-max="" value="{{ $row->promotion_stock }}" disabled> --}}
                                                            </td>
                                                            <!-- <td>
 ...
 -->                                                        </tr>
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--begin::Image input-->
                                    <div class="image-input image-input-empty" data-kt-image-input="true" style="background-image: url({{ $edit->image != '' ? asset_administrator("assets/media/banners/$edit->image") : asset_administrator("assets/media/avatars/default.jpg")}})">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <div class="form-check form-switch form-check-custom form-check-solid">
                                        <input class="form-check-input" type="checkbox" value="1" id="status" name="status" {{ $edit->status == 1 ? 'checked="checked"' : '' }} disabled/>
                                        <label class="form-check-label fw-bold text-gray-400 ms-3" for="status">Active</label>
                                    </div>
                                </div>
                                <div class="mb-10 fv-row">
                                    <label class="form-label">Note</label>
                                    <textarea name="note" class="form-control" disabled>{{ $edit->note }}</textarea>
                                </div>
                            </div>
                            <!--end::Card header-->
                        </div>
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{ route('admin.promo_products') }}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Back</a>
                            <!--end::Button-->
                            <!--begin::Button-->
                    ...
                    <div class="mb-5">
                        <div class="mh-375px scroll-y me-n7 pe-7">
                            <div class="col-lg-4 mt-5" style="float: right !important">
                                <input type="text" class="form-control form-control-sm" placeholder="Search" id="searchProductTable" />
                            </div>
        ...
        <tr class="template-product-list" childidx="0" style="position: relative;">
            ...
            <td>
                <div class="col-auto">
                    ...
                    <input type="text" class="form-control form-white text-end discount_value_product" name="product[0][discount_value_product]" data-max="" required>
                </div>
            </td>
            ...
            <td>
                ...
                {{-- <input type="text" class="form-control form-white text-end withseparator format-number promotion_stock" name="product[0][promotion_stock]" data-max="" required> --}}
            </td>
            <td>
                <a href="#" class="btn btn-sm btn-icon btn-light btn-active-light-primary removeData">
                    <span class="svg-icon svg-icon-2">
    ...
    <script type="text/javascript">
        ...
        function resetData() {
            ...
            $(".product-list").each(function () {
                ...
                $(this).find(".discount_value_product").on("keyup", function() {
                    if($(".discount_type_product").is(':checked')){
                        $(another).find(".after_discount_price").text($(another).find(".price").text() - ($(another).find(".price").text() * $(this).val() / 100));
                        $(another).find(".after_discount_price_value").val($(another).find(".price").text() - ($(another).find(".price").text() * $(this).val() / 100));
                    }else{
                        $(another).find(".after_discount_price").text($(another).find(".price").text() - $(this).val());
                        $(another).find(".after_discount_price_value").val($(another).find(".price").text() - $(this).val());
                    }
                });
        ...
        function getProduct() {
            ...
            $('#selectData-product').on('click', function (e, dt, node, config) {
                var rows_selected = table_product.rows( { selected: true } ).data();
                ...
                $.each(rows_selected, function () {
                    ...
                    if (parseInt(exist_product) == -1) {
                        ...
                        tr_clone.find(".discount_value_product").val(discount_value);
