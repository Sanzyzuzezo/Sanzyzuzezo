            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-dark">Units</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            ...
                            <div class="card-toolbar">
                                @if (isAllowed("units", "add"))
                                <a href="{{ route('admin.units.add') }}" class="btn btn-sm btn-light-primary">
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            var data_units = $('#units-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "units-data",
            ...
            $('#searchdatatable').keyup(function() {
                data_units.search($(this).val()).draw();
            })

            $('#filterstatus').change(function() {
                data_units.search($("#searchdatatable").val()).draw();
            })
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function(resp){
                                ...
                                data_units.ajax.reload(null, false);
                            },
                            error: function (resp) {
