                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--begin::Input-->     
                                        @if ($company_id != 0)
                                        <input type="hidden" name="user_group" value="{{ $user_groups->id }}">
                                        <select name="user_group" class="form-select" data-control="select2" disabled>
                                           <option value="{{ $user_groups->id }}" selected> {{ $user_groups->name }} </option>
                                        </select>
                                        @else
                                ...
                                <!--end::Input group-->
                                @if ($data_user->user_group_id == 0)
                                <div class="mb-10 fv-row">
                                    <div class="form-check form-check-custom form-check-solid mb-2">
                                        <input class="form-check-input" type="checkbox" name="general_admin"
                                            value="1" />
                                        <label class="form-check-label" for="general_admin">Is General Admin?</label>
                                    </div>
                                </div>
                                @else
                                ...
                                <div class="mb-10 fv-row">
                                    <div class="form-check form-check-custom form-check-solid mb-2">
                                        <input class="form-check-input cashier" type="checkbox" name="cashier"
                                            id="cashier" value="1" />
                                        <label class="form-check-label" for="cashier">Is Cashier?</label>
                                    </div>
                                </div>
                                <div class="mb-10 fv-row d-none" id="store">
                                    <label class="form-label required">Store</label>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <input type="hidden" name="store_id" class="form-control store_id"
                                                value="" />
                                            <input type="text" name="store_name" class="form-control store_name"
                                                placeholder="Store Name" value="" readonly />
                                        </div>
                                ...
                                <div class="mb-10 fv-row">
                                    <div class="form-check form-check-custom form-check-solid mb-2">
                                        <input class="form-check-input warehouse_pic" type="checkbox"
                                            name="warehouse_pic" id="warehouse_pic" value="1" />
                                        <label class="form-check-label" for="warehouse_pic">Is Warehouse PIC?</label>
                                    </div>
                                </div>
                                <div class="mb-10 fv-row">
                                    <div class="form-check form-check-custom form-check-solid mb-2">
                                        <input class="form-check-input employee" type="checkbox" name="employee"
                                            id="employee" value="1" />
                                        <label class="form-check-label" for="employee">Is Employee ?</label>
                                    </div>
                                </div>
                                <div class="mb-10 fv-row d-none" id="warehouse">
                                    <label class="form-label required">Warehouse</label>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <input type="hidden" name="warehouse_id" class="form-control warehouse_id"
                                                value="" />
                                            <input type="text" name="warehouse_code"
                                                class="form-control warehouse_code" placeholder="Warehouse Code"
                                                value="" readonly />
                                        </div>
                                        <div class="col-md-3">
                                            <input type="text" name="warehouse_name"
                                                class="form-control warehouse_name" placeholder="Warehouse Name"
                                                value="" readonly />
                                        </div>
    ...
    <script type="text/javascript">
        ...
        function getStore() {
            ...
            $('#dataStore').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{ route('admin.users.store-data') }}",
                    "dataType": "JSON",
                    "type": "GET",
                    "data": {
                        datatable: true,
            ...
            $('#selectData-store').on('click', function(e, dt, node, config) {
                var rows_selected = table_store.rows({
                    selected: true
                }).data();
        ...
        function getWarehouse() {
            ...
            $('#dataWarehouse').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{ route('admin.users.warehouse-data') }}",
                    "dataType": "JSON",
                    "type": "GET",
                    "data": {
                        datatable: true,
            ...
            $('#selectData-warehouse').on('click', function(e, dt, node, config) {
                var rows_selected = table_warehouse.rows({
                    selected: true
                }).data();
                // console.log(rows_selected[0]);
