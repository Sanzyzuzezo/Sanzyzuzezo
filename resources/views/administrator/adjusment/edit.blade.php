        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <form id="form" class="form d-flex flex-column flex-lg-row"
                    action="{{ route('admin.adjusment.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PUT') }}
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <input type="text" name="date" class="form-control" value="{{ date('d-m-Y', strtotime($edit->date)) }}" readonly/>
                                        </div>
                                    </div>
                                                    ...
                                                    @foreach ($adjusment_detail as $row)
                                                        ...
                                                        <tr class="item-list" childidx="0" style="position: relative;" id="item{{ $no }}">
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="hidden" class="item_id" name="item[0][item_id]" value="{{ $row->item_id }}">
                                                                <input type="hidden" class="item_variant_id" name="item[0][item_variant_id]" value="{{ $row->item_variant_id }}">
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control form-white text-end withseparator format-number current_stock" name="item[0][current_stock]" value="{{ number_format($row->current_stock, 2) }}" readonly>
                                                            </td>
                                                            <td>
                                                                <input type="hidden" class="form-control form-white text-end withseparator format-number" name="item[0][stock]" value="{{ number_format($row->new_stock, 2) }}">
                                                                <input type="text" class="form-control form-white text-end withseparator format-number new_stock" name="item[0][new_stock]" value="{{ number_format($row->new_stock, 2) }}">
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control form-white text-end withseparator format-number difference" name="item[0][difference]" value="{{ number_format($row->difference, 2) }}" {{ $row->current_stock == 0 ? 'readonly' : '' }}>
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control" name="item[0][note]" value="{{ $row->note }}">
                                                            </td>
                                                            <td>
    ...
    <table class="template-data" style="display: none;">
        <tr class="template-item-list" childidx="0" style="position: relative;">
            ...
            <td>
                ...
                <input type="hidden" class="form-control form-white text-end withseparator format-number" name="item[0][stock]" value="0">
