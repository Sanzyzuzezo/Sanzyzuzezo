            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Adjusment</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            <div class="card-toolbar">
                                ...
                                <a href="{{ route('admin.adjusment.add') }}" class="btn btn-sm btn-light-primary">
                    ...
                    <div class="card-body pt-0">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_adjusment_table">
                            <!--begin::Table head-->
                            <thead>
                                <!--begin::Table row-->
...
@push('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var data_adjusment = $('#kt_ecommerce_adjusment_table').DataTable({
                processing: true,
                serverSide: true,
                ordering: true,
                ajax: {
                    url: '{{ route('admin.adjusment.getData') }}',
                    dataType: "JSON",
                    type: "GET"
                },
                columns: [{
            ...
            $('#searchdatatable').keyup(function() {
                data_adjusment.search($(this).val()).draw();
            })
            ...
            $(document).on('click', '.delete', function(event) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "POST",
                            url: "{{ route('admin.adjusment.delete') }}",
                            data: ({
                                "_token": "{{ csrf_token() }}",
                                "_method": 'DELETE',
                                ix: ix,
                            ...
                            success: function(resp){
                                ...
                                data_adjusment.ajax.reload(null, false);
                            },
                            error: function (resp) {
