            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            ...
                            <div class="card-toolbar">
                                @if (isAllowed('companies', 'add'))
                                    <a href="{{ route('admin.companies.add') }}" class="btn btn-sm btn-light-primary">
                    ...
                    <div class="card-body pt-0">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="company_table">
                            <!--begin::Table head-->
                            <thead>
                                <!--begin::Table row-->
...
@push('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var data_company = $('#company_table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
            ...
            $('#searchdatatable').keyup(function() {
                data_company.search($(this).val()).draw();
            })

            $('#filterstatus').change(function() {
                data_company.search($("#searchdatatable").val()).draw();
            })
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function() {
                                ...
                                data_company.ajax.reload(null, false);
                            }
                        });
