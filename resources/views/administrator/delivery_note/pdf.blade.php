                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-header"style="clear:both; position:relative;">
                        ...
                        <div class="card-title" style="margin-left:150pt; margin-bottom:50pt;">
                            <h2>Detail Surat Jalan Penjualan</h2>
                        </div>
                    </div>
                    <!--end::Card header-->
                    <!--begin::Card body-->
                                    ...
                                    <table class="table detail gy-3 fs-7">
                                        <thead style="vertical-align: top;">
                                            <tr class="fw-bolder bg-light detail">
                                                ...
                                                <th class="p-2 detail">Warehouse</th>
                                                <th class="p-2 detail">Item</th>
                                                <th class="p-2 detail">Item Variant</th>
                                                <th class="p-2 detail">Stock</th>
                                                <th class="p-2 detail">Quantity Sales</th>
                                                <th class="p-2 detail">Quantity</th>
                                                {{-- <th class="p-2 detail">Check</th> --}}
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($data_detail as $key => $detail)
                                                <tr>
                                                    ...
                                                    <td class="p-2 detail">{{ $detail['nama_warehouse'] }}</td>
                                                    <td class="p-2 detail">{{ $detail['nama_item'] }}</td>
                                                    <td class="p-2 detail">{{ $detail['nama_item_variant'] }}</td>
                                                    <td class="p-2 detail text-end">{{ number_format($detail['stock']) }}</td>
                                                    <td class="p-2 detail text-end">{{ number_format($detail['quantity_sales']) }}</td>
                                                    <td class="p-2 detail text-end">{{ number_format($detail['quantity']) }}</td>
                                                    {{-- <td class="p-2 detail text-end"></td> --}}
                                                </tr>
                                            @endforeach
                                            {{-- <tr class="fw-bold">
