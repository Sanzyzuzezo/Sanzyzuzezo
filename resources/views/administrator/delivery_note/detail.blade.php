                                        ...
                                        <div class="card-header w-100">
                                            <div class="card-title w-100">
                                                ...
                                                <div class="card-toolbar ms-auto">
                                                    @if (isAllowed('delivery_note', 'export'))
                                                        <a href="javascript:void(0)" class="btn btn-sm btn-light-success mx-1" id="triggerExportExcel">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <input type="text" name="customer_name"
                                                    class="form-control bg-secondary" placeholder="Customer Name"
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <input type="text" name="sales_number"
                                                    placeholder="Nomor Surat Jalan" id="sales_number"
                                                    class="form-control bg-secondary"
                                                    value="{{ $data->sales_number }}" readonly />
                                                <input type="hidden" id="status_sales_number"
                                                    name="status_sales_number" value="false"
                                                    class="form-control bg-secondary" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <input type="text" name="license_plate_number"
                                                    ...
                                                    value="{{ $data->license_plate_number }}" class="form-control bg-secondary" readonly/>
                                            </div>
                                        </div>
                                    </div>
                                    <!--end::Input group-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <input type="text" name="weather" placeholder="Weather" id="weather"
                                                    value="{{ $data->weather }}" class="form-control bg-secondary" readonly/>
                                            </div>
                                        </div>
                                    </div>
                                    <!--end::Input group-->
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <textarea name="information" id="information" cols="30" rows="5" class="form-control"
                                                    autocomplete="off" disabled>{{ $data->information }}</textarea>
                                            </div>
                                        </div>
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                                    ...
                                                    <tbody class="fw-bold text-gray-600" id="bodyTableDetail">
                                                        @if (!empty($data_detail))
                                                            @foreach ($data_detail as $key => $detail)
                                                                ...
                                                                <input type="hidden" class="delivery_note_detail_id-item"
                                                                    ...
                                                                    <td class="quantity-item text-end fv-row">
                                                                        <input type="text"
                                                                            class="form-control quantity-item text-end bg-secondary"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
                        ...
                        success: function(data) {
                            ...
                            if ($('#row_detail_' + data.id).length == 0) {
                                ...
                                $('#bodyTableDetail').append(
                                    '<tr id="row_detail_' + data.id +
                                    '" class="row_detail" childidx="0">' +
                                    '<input type="hidden" class="form-control delivery_note_detail_id-item text-end" name="detail[' +
                                    number + '][delivery_note_detail_id]" value="" autocomplete="off">' +
                                    '<td class="no-item">' + (number + 1) +
                                    '</td>' +
                                    '<td class="warehouse-item">' +
                                    data.nama_warehouse +
                                    '<input type="hidden" class="warehouse_id-item" name="detail[' +
                                    number + '][warehouse_id]" value="' + data
                                    .warehouse_id + '">' +
                                    '</td>' +
                                    ...
                                    '<td class="stock-item text-end">' +
                                    data.stock +
                                    '<input type="hidden" class="stock_id-item" name="detail[' +
                                    number + '][stock_id]" value="' + data
                                    .stock_id + '">' +
                                    '</td>' +
                                    '<td class="quantity_sales-item text-end">' +
                                    data.quantity_sales +
                                    '</td>' +
                                    '<td class="quantity-item text-end fv-row">' +
                                    '<input type="text" class="form-control quantity-item text-end" name="detail[' +
                                    ...
                                    'data-id="' + data.id +
                                    '" data-delivery_note_detail_id="" data-bs-toggle="tooltip" data-bs-placement="top">' +
            ...
            $('#triggerExportExcel').on('click', function() {
                ...
                window.open("{{ route('admin.delivery_note.exportExcel') }}" + "?" + params.join('&'), "_blank");
            });
            ...
            $('#triggerExportPdf').on('click', function() {
                ...
                window.open("{{ route('admin.delivery_note.exportPdf') }}" + "?" + params.join('&'), "_blank");
            });
