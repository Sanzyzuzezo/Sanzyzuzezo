...
<head>
    ...
    <link href="{{ asset_administrator('assets/plugins/custom/fullcalendar/fullcalendar.bundle.css') }}"
        rel="stylesheet" type="text/css" />
    <link href="{{ asset_administrator('assets/plugins/custom/datatables/datatables.bundle.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset_administrator('assets/plugins/custom/jstree/jstree.bundle.css') }}" rel="stylesheet"
        type="text/css" />
    ...
    <!--begin::Owl Carousel-->
    <link href="{{ asset_administrator('assets/plugins/custom/carousel/owl.carousel.min.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset_administrator('assets/plugins/custom/carousel/owl.theme.default.min.css') }}" rel="stylesheet"
        type="text/css" />
    <!--end::Owl Carousel-->
...
<body id="kt_body"
    ...
    <!--begin::CKeditor Javascript(used by this page)-->
    <script src="{{ url('administrator\ckeditor\ckeditor.js') }}"></script>
    <!--end::CKeditor Custom Javascript-->
    <!--begin::Owl Carousel-->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js"></script>
    <script src="{{ asset_administrator('assets/js/custom/carousel/owl.carousel.min.js') }}"></script>
    <!--end::Owl Carousel-->
    @stack('scripts')
    <!--end::Page Custom Javascript-->
    <!--end::Javascript-->
