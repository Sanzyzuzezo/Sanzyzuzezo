...
@section('content')
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <form id="form" class="form d-flex flex-column flex-lg-row" action="{{ route('admin.buys.update') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                    ...
                                    <div class="row mb-5 mt-5">
                                        <div class="col-md-6">
                                            <div class="fv-row">
                                                ...
                                                <input type="text" name="tanggal" placeholder="Tanggal" class="form-control kt_datepicker_1 text-end" value="{{ date('d F Y', strtotime($edit->tanggal)) }}"/>
                                        ...
                                        <div class="col-md-6">
                                            <div class="fv-row mb-5">
                                                ...
                                                <input type="text" name="nomor_pembelian" class="form-control" value="{{$edit->nomor_pembelian}}" readonly>
                                    ...
                                    <div class="row mb-10">
                                        <div class="col-md-6">
                                            <div class="fv-row mb-5">
                                                ...
                                                <select name="gudang" class="form-select" data-control="select2" data-hide-search="true" data-placeholder="Please Select">
                                                    <option value="">Please Select</option>
                                                    @foreach($warehouses as $warehouse)
                                                        <option value="{{ $warehouse->id }}" {{ $edit->warehouse_id == $warehouse->id ? 'selected' : '' }}>{{ $warehouse->name }}</option>
                                                    @endforeach
                                                </select>
                                                <div class="text-muted fs-7">
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="fv-row mb-5">
                                                ...
                                                <select name="supplier" class="form-select" data-control="select2" data-hide-search="true" data-placeholder="Please Select">
                                                    <option value="">Please Select</option>
                                                    @foreach($supplier as $supply)
                                                        <option value="{{ $supply->id }}" {{ $edit->supplier_id == $supply->id ? 'selected' : '' }}>{{ $supply->name }}</option>
                                                    @endforeach
                                                </select>
                                                <div class="text-muted fs-7">
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="listDataItem">
                                                ...
                                                <tbody class="fw-bold text-gray-600" id="get-item-data">
                                                        {{-- <tr class="item-list align-top" childidx="0" style="position: relative;">
                                                            <td class="fv-row">
                                                                <select class="form-select" name="item[0][kategori_biaya]" required>
                                                                    <option value="">Please Select</option>
                                                                </select>
                                                            </td>
                                                            <td class="fv-row">
                                                                <input type="text" class="form-control form-white" name="item[{{ $n }}][jenis_deskripsi]" value="" required>
                                                            </td>
                                                            <td class="fv-row">
                                                                <input type="text" class="form-control form-white text-end withseparator format-number harga" name="item[{{ $n }}][harga]" value="" required>
                                                            </td>
                                                            <td class="fv-row">
                                                                <input type="text" class="form-control form-white text-end withseparator format-number jumlah" name="item[{{ $n }}][jumlah]" value="" required>
                                                            </td>
                                                            <td class="fv-row">
                                                                <input type="text" class="form-control form-white" name="item[{{ $n }}][satuan]" value="" required>
                                                            </td>
                                                            <td class="fv-row">
                                                                <input type="text" class="form-control form-white text-end withseparator format-number total" name="item[{{ $n }}][total]" value="" required readonly>
                                                            </td>
                                                            <td class="fv-row">
                                                                <div>
                                                                    <span class="btn btn-icon btn-bg-light btn-file btn-active-color-primary btn-sm me-1 svg-icon svg-icon-muted svg-icon-3">
                                                                        ...
                                                                        <input type="file" name="item[{{ $n }}][image]" accept="image/jpeg, image/png, image/jpg" onchange="handleFileChange(this)">
                                                                    </span>
                                                                    <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 showImage"
                                                                    data-image="{{asset_administrator("assets/media/buys/")}}">
                                                        ...
                                                        @foreach ($detail as $n => $data)
                                                        <tr class="item-list" childidx="0" style="position: relative;">
                                                            <td class="fv-row">
                                                                <div class="d-flex flex-row">
                                                                    <input type="hidden" class="form-control form-control-sm form-control-solid text-dark mw-100px id" placeholder="Id" name="item[{{ $n }}][id]" value="{{ $data['id'] }}" readonly>
                                                                    <input type="hidden" class="form-control form-control-sm form-control-solid text-dark mw-100px account_id" placeholder="Id" name="item[{{ $n }}][product_variant_id]" value="{{ $data['product_variant_id'] }}" readonly>
                                                                    <input type="text" class="form-control form-control-sm form-control-solid text-dark account_nama1 mx-1" placeholder="Product" name="item[{{ $n }}][item_name]" value="{{ $data['item_name'] }}" readonly>
                                                                    <input type="text" class="form-control form-control-sm form-control-solid text-dark account_nama2 mx-1" placeholder="Variant" name="item[{{ $n }}][item_variant_name]" value="{{ $data['item_variant_name'] }}" readonly>
                                                                    <a class="btn btn-sm btn-light-primary modalAccount2">
                                                            ...
                                                            <td class="fv-row">
                                                                <input type="text" class="form-control form-white text-end withseparator format-number harga" name="item[{{ $n }}][harga]" data-max="" data-item="" data-variant="" value="{{ $data['harga'] }}" required>
                                                            </td>
                                                            <td class="fv-row">
                                                                <input type="text" class="form-control form-white text-end withseparator format-number jumlah" name="item[{{ $n }}][jumlah]" data-max="" data-item="" data-variant="" value="{{ $data['jumlah'] }}" required>
                                                            </td>
                                                            <?php
                                                            $variant = App\Models\ProductVariant::select(DB::raw('units.name, 0 as id'))
                                                                ->where('product_variants.id', $data->product_variant_id) // <-- Complete the statement
                                                            ...
                                                            $uk = App\Models\UnitConversion::select(DB::raw('unit_conversions.new_unit as name, unit_conversions.id'))
                                                                ...
                                                                ->where('unit_conversions.item_variant_id', $data->product_variant_id);
                                                            
                                                            $units = $variant->union($uk)->get();
                                                            ?>
                                                            <td class="fv-row">
                                                                <select class="form-select unit-item" name="item[{{ $n }}][unit]" required>
                                                                    <option value="">Please Select</option>
                                                            ...
                                                            <td class="fv-row">
                                                                <input type="text" class="form-control form-white text-end withseparator format-number total" name="item[{{ $n }}][total]" data-max="" data-item="" data-variant="" value="{{ $data['total'] }}" required readonly>
                                                            </td>
                                                            <td class="fv-row">
                                                                <input type="text" name="item[{{ $n }}][expired]" placeholder="Expired" class="form-control kt_datepicker_2 text-end" value="{{ $data['expired'] ? date('Y-m-d', strtotime($data['expired'])) : ''}}"/>
                                                            </td>
                                                            {{-- <td class="fv-row">
                                                                <div>
                                                                    <span class="btn btn-icon btn-bg-light btn-file btn-active-color-primary btn-sm me-1 svg-icon svg-icon-muted svg-icon-3">
                                                ...
                                                <tfoot class="fw-bold text-gray-600">
                                                    <tr style="position: relative;">
                                                        <td class="fv-row text-end align-center fs-5 fw-bold text-dark" colspan="5">
                                                            Total Price
                                                        </td>
                                                        <td class="fv-row">
                                                            <input type="text" class="form-control form-white text-end withseparator format-number total_keseluruhan" name="total_keseluruhan" value="{{ strtolower($edit->total_keseluruhan) }}" required readonly>
                                                        </td>
                                                    </tr>
                                                </tfoot>
                                                <!--end::Table body-->
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{ route('admin.buys') }}" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Cancel</a>
                            <!--end::Button-->
                            <!--begin::Button-->
    ...
    <table class="template-data" style="display: none;">
        <tr class="template-item-list" childidx="0" style="position: relative;">
            <td class="fv-row">
                <div class="d-flex flex-row">
                    <input type="hidden" class="form-control form-control-sm form-control-solid text-dark mw-100px account_id" placeholder="Nama" name="item[0][product_variant_id]" readonly>
                    <input type="text" class="form-control form-control-sm form-control-solid text-dark account_nama1 mx-1" placeholder="Product" name="item[0][item_name]" readonly>
                    <input type="text" class="form-control form-control-sm form-control-solid text-dark account_nama2 mx-1" placeholder="Variant" name="item[0][item_variant_name]" readonly>
                    <a class="btn btn-sm btn-light-primary modalAccount2">
                        <span class="svg-icon svg-icon-4 m-0">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <rect opacity="0.5" x="17.0365" y="15.1223" width="8.15546" height="2" rx="1" transform="rotate(45 17.0365 15.1223)" fill="black" />
            ...
            <td class="fv-row">
                <input type="text" class="form-control form-white text-end withseparator format-number harga" name="item[0][harga]" data-max="" data-item="" data-variant="" required>
            </td>
            <td class="fv-row">
                <input type="text" class="form-control form-white text-end withseparator format-number jumlah" name="item[0][jumlah]" data-max="" data-item="" data-variant="" required>
            </td>
            <td class="fv-row">
            ...
            <td class="fv-row">
                <input type="text" class="form-control form-white text-end withseparator format-number total" name="item[0][total]" data-max="" data-item="" data-variant="" required readonly>
            </td>
            <td class="fv-row">
                <input type="text" name="item[0][expired]" placeholder="Expired" class="form-control kt_datepicker_2 text-end" value=""/>
            </td>
            {{-- <td class="fv-row">
                <div>
                    <span class="btn btn-icon btn-bg-light btn-file btn-active-color-primary btn-sm me-1 svg-icon svg-icon-muted svg-icon-3">
                    ...
                    <div class="mb-5">
                        <div class="mh-375px scroll-y me-n7 pe-7">
                            <div class="col-lg-4 mt-5" style="float: right !important">
                                <input type="text" class="form-control form-control-sm" placeholder="Search" id="searchAccountTable2" />
                            </div>
...
<script>
    function getAccount2(another){
            ...
            $('#selectData-account2').on('click', function (e, dt, node, config) {
                var rows_selected = table_account.rows( { selected: true } ).data();
    ...
    <script type="text/javascript">
        ...
        function resetData() {
            ...
            $(".item-list").each(function () {
                ...
                $(".harga").on('keyup', function() {
                    ...
                    let formatter = new Intl.NumberFormat('en-US', { style: 'currency', currency: 'IDR' });
                    ...
                    let total_keseluruhan_format = formatter.format(total_keseluruhan).replace("IDR", "").trim(); // Menghapus teks 'IDR'
        ...
        function addValidation(){
            $(".item-list").each(function() {
                ...
                // if($(another).find('.showImage').attr('data-image').length <= 0){
        ...
        function removeValidation(){
                $(".item-list").each(function() {
                    ...
                    // if($(this).find('.showImage').attr('data-image').length <= 0){
