...
<section class="ec-page-content ec-vendor-uploads ec-user-account section-space-p">
    <div class="container section-space-mb">
    ...
    <div class="container">
        <div class="row">
            <div class="ec-shop-rightside col-lg-12">
                <div class="ec-vendor-dashboard-card">
                    ...
                    <div class="ec-vendor-card-body">
                        <div class="ec-vendor-card-table overflow-visible" id="tag_container">
                            @include('frontpage-schoko.customers.order_list')
                        </div>
                    </div>
                </div>
            </div>
