<header class="ec-header">
    ...
    <div class="ec-nav-header">
        <div class="container position-relative">
            <div class="row">
                <div class="col-md-2 align-self-center" style="width:30px;">
                    <div class="ec-main-menu">
                        <a href="{{ route('search') }}" class="ec-header-btn"><img src="{{ asset_frontpage("assets/images/icons/search.svg") }}" class="svg_img header_svg" alt="icon" style="padding-left: 20px;" /></a>
                    </div>
                </div>
                <div class="col-md-11 align-self-center">
                    <div class="ec-main-menu">
                        <a href="{{ route("home") }}">
                            <img src="{{ img_src($navbar['settings']['logo'], "logo") }}" alt="Site Logo" style="max-width: 70px; padding-bottom: 24px; padding-top: 16px;">
                            <img class="dark-logo" src="{{ img_src($navbar['settings']['logo'], "logo") }}" alt="Site Logo" style="display: none;" />
                        </a>
                    </div>
                </div>
