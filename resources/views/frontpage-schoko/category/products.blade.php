            ...
            <div class="row">
                <div class="ec-shop-rightside col-lg-12 order-lg-last col-md-12 order-md-first margin-b-30">
                    ...
                    <div class="shop-pro-content" id="tag_container">
                        @include('frontpage-schoko.category.product_list')
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.pagination a', function(event) {
                ...
                var link = $(this).attr('href').split('category')[1];
        ...
        function getData(page, link) {
            var slug = window.location.pathname;
            slug = slug.split("/").pop()

            if (page == undefined) {
                var url = '{{ route("category") }}/'+slug;
            } else {
                var url = '{{ route("category") }}/' + slug  +'?page=' + page;
            }
