                ...
                <div class="row ec_breadcrumb_inner">
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <ul class="ec-breadcrumb-list">
                            ...
                            <li class="ec-breadcrumb-item active">{{ session()->get('locale') == 'id' ? $detail->title : $detail->title_an }}</li>
                        </ul>
                    ...
                    <div class="ec-blogs-inner">
                        <div class="ec-blog-main-img">
                            ...
                            @if (end($ext) == 'jpg' || end($ext) == 'jpeg' || end($ext) == 'gif' || end($ext) == 'png')
                                <img src="{{ img_src($detail->data_file, "news") }}" alt="{{ session()->get('locale') == 'id' ? $detail->title : $detail->title_an }}" />
                        ...
                        <div class="ec-blog-detail">
                            <h3 class="ec-blog-title">{{ session()->get('locale') == 'id' ? $detail->title : $detail->title_an }}</h3>
                            {!! session()->get('locale') == 'id' ? $detail->description : $detail->description_an !!}
                        </div>
                    </div>
                </div>
                <!--Blog content End -->
                    ...
                    <div class="ec-sidebar-block ec-sidebar-recent-blog">
                        ...
                        <div class="ec-sb-block-content">
                            ...
                            <div class="ec-sidebar-block-item">
                                <h5 class="ec-blog-title"><a href="{{ route("news_detail",$row->slug) }}">{{ session()->get('locale') == 'id' ? $row->title : $row->title_an }}</a></h5>
                    ...
                    {{-- <div class="ec-sidebar-block">
                        ...
                        <div class="ec-sb-block-content">
                            <ul>
                                ...
                                <li>
                                    <div class="ec-sidebar-block-item">
                                        <input type="checkbox" checked /> <a href="#">{{ session()->get('locale') == 'id' ? $row->name : $row->name_an }}</a><span
                                            class="checked"></span>
                                    </div>
                                </li>
                                @endforeach
