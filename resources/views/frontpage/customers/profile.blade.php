                                    ...
                                    <div class="ec-vendor-block-profile">
                                        <div class="ec-vendor-block-img space-bottom-30">
                                            ...
                                            <div class="ec-vendor-block-detail">
                                                <img class="v-img" src="{{ $detail->image != "" ? asset('storage/'.$detail->image) : asset('frontpage/assets/images/user/1.jpg') }}" alt="vendor image">
                                ...
                                <div class="ec-vendor-block-detail">
                                    <div class="thumb-upload">
                                        ...
                                        <div class="thumb-preview ec-preview">
                                            <div class="image-thumb-preview">
                                                {{--  --}}
                                                <img class="image-thumb-preview ec-image-preview v-img" src="{{ $detail->image != "" ? asset('storage/'.$detail->image) : asset('frontpage/assets/images/user/1.jpg') }}" alt="edit" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
