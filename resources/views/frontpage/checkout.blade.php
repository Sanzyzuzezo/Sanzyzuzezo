            ...
            <div class="row">
                @if (isset($cart_data))
                    @if (Cookie::get('shopping_order'))
                        @php $total="0" @endphp
                        <div class="ec-cart-leftside col-lg-8 col-md-12 pb-4">
                                                        ...
                                                        <tr class="cart-list">
                                                            <td data-label="Product" class="ec-cart-pro-name">
                                                                <div class="d-flex flex-row">
                                                                    <div>
                                                                        <img class="ec-cart-pro-img" src="{{ img_src($data->image, 'product') }}" alt="" />
                                                                    </div>
                                                                    <div class="d-flex justify-content-start flex-column p-2">
                                                                        <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">{{ strlen($data['name']) > 24 ? substr($data['name'], 0, 25) . '...' : $data['name'] }}</a>
                        ...
                        @if (isset(auth()->user()->id))
                            <div class="ec-cart-leftside col-lg-8 col-md-12 mb-5">
                                <div class="ec-sidebar-wrap">
                                    <div class="ec-sidebar-block">
                                        <div class="ec-checkout-wrap margin-bottom-30 padding-bottom-3">
                                            <div class="ec-checkout-block ec-check-bill">
                        ...
                        <div class="ec-cart-leftside col-lg-8 col-md-12 mt-5 text-center">
