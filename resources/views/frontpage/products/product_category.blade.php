            ...
            <div class="col-12">
                <div class="row ec_breadcrumb_inner">
                    <div class="col-md-6 col-sm-12">
                        <h2 class="ec-breadcrumb-title">{{ __('home.category') }}</h2>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <ul class="ec-breadcrumb-list">
                            <li class="ec-breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                            <li class="ec-breadcrumb-item active">{{ __('home.category') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="ec-blog-inner">
                                    <div class="ec-blog-image">
                                        <a href="{{ route('category_detail', $category->id) }}">
                                            <img class="blog-image" src="{{ img_src($category->image, "category") }}" alt="{{ $category->name }}" />
                                        </a>
                                    </div>
                                    <div class="ec-blog-content">
                                        <h5 class="ec-blog-title"><a href="{{ route('category_detail', $category->id) }}">{{ $category->name }}</a></h5>
                                        <div class="ec-blog-btn"><a href="{{ route('category_detail', $category->id) }}" class="btn btn-primary">Detail</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
